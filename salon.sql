...
INSERT INTO public.services VALUES (2, 'lights');
INSERT INTO public.services VALUES (3, 'hidratyon');
...
ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT service_id FOREIGN KEY (service_id) REFERENCES public.services(service_id) ON DELETE CASCADE;
